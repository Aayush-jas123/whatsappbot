...
// Admin dashboard CSP override — inline onclick handlers generated by JS
// via innerHTML, Google Fonts CSS, and inline styles all need relaxation.
// Applied to both /dashboard (static) and /admin (sendFile) since they
// serve the same markup.
...
app.use('/dashboard', dashboardCsp);
app.use('/admin', dashboardCsp);
